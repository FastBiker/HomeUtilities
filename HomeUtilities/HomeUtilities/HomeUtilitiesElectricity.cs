...
{
    public class HomeUtilitiesElectricity : HomeUtilitiesBase
    {
        private const string fileName = "amounts_electrycity.txt";
        public HomeUtilitiesElectricity(string utilities)
            : base(utilities)
        {
        }
